...
public class StartProcessListener {
  ...
  public String start() {
    System.out.println("Starting process main-v1");
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("main", "Nr. 123", Variables.putValue("FormField_19huq07", "Nr. 123").putValue("myvar","myval"));
