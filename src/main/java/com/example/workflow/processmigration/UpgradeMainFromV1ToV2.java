package com.example.workflow.processmigration;
...
public class UpgradeMainFromV1ToV2 {
  ...
  private final VariableStep rename_formField_19huq07_to_invoiceNumber = VariableStep.builder()
    ...
    .build();
private final VariableDeleteStep variableDeleteStep = VariableDeleteStep.builder().deleteStrategy(new ReadProcessVariable()).variableName("myvar").build();
